                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('brgmasuk.store') }}" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="exampleInputPassword1" class="col-sm-3 col-form-label">Masukan Kode
                                            Barang</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group row">
                                        <label for="exampleInputPassword1" class="col-sm-3 col-form-label">Nama
                                            Barang</label>
                                        <div class="col-sm-9">
        ...
        $('#addrow').click(function() {
            ...
            <div class="card-body hapus">
                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="exampleInputPassword1" class="col-sm-3 col-form-label">Masukan Kode Barang</label>
                                    <div class="col-sm-9">
                                        <input value="{{ $item->kodebarang }}" type="text" name="kodebarang[]"
