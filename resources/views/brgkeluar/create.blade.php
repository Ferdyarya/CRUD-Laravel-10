                    ...
                    <div class="card">
                        <form method="POST" action="{{ route('brgkeluar.store') }}" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="id_toko" class="col-sm-3 col-form-label">Nama Toko</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="exampleInputPassword1" class="col-sm-3 col-form-label">Alamat</label>
                                    <div class="col-sm-9">
        ...
        $('#addrow').click(function() {
            ...
            <div class="card-body hapus">
                ...
                <div class="form-group row">
                    <label for="exampleInputPassword1" class="col-sm-3 col-form-label">Qty</label>
                    <div class="col-sm-9">
                        <input type="number" name="qty[]" class="form-control" id="exampleInputPassword1" placeholder="Masukan Qty" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="exampleInputPassword1" class="col-sm-3 col-form-label">Alamat</label>
                    <div class="col-sm-9">
                        <input type="text" name="alamat[]" class="form-control" id="exampleInputPassword1" placeholder="Masukan Alamat" required>
                    </div>
                </div>
