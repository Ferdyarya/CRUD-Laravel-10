    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" /> --}}
        ...
        <div class="container">
            ...
            <div class=" mb-2">
                ...
                <form action="{{ route('laporanbrgretur')}}" method="GET">
                    <div class="input-group">
                        ...
                        <div class="pt-4">
                            @if (!empty($filter))
                                <a href="{{ route('laporanbrgreturpdf', $filter) }}" class="btn btn-danger">Export PDF</a>
                            @else
                                <a href="{{ route('laporanbrgreturpdf', 'all') }}" class="btn btn-danger">Export PDF</a>
                            @endif
                        </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        @php
                            $no = 1;
                        @endphp
                        @foreach ($laporanbrgretur as $item)
                        <tr>
