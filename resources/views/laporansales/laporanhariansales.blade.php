    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Laporan Harian Sales</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" /> --}}
        ...
        <div class="container">
            ...
            <div class=" mb-2">
                ...
                <form action="{{ route('laporanhariansales')}}" method="GET">
                    <div class="input-group">
                        ...
                        <div class="pt-4">
                            @if (!empty($filter))
                                <a href="{{ route('laporanhariansalespdf', $filter) }}" class="btn btn-danger">Export PDF</a>
                            @else
                                <a href="{{ route('laporanhariansalespdf', 'all') }}" class="btn btn-danger">Export PDF</a>
                            @endif
                        </div>
